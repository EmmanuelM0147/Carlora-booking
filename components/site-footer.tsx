        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Carlora Strategic Innovation is a dynamic consulting firm committed to helping individuals, start-ups, and established businesses thrive in a rapidly changing world. We combine strategic insight, creativity, and practical solutions to support your growth, whether you're launching a new venture or reimagining your current operations.
